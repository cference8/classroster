...
public class CourseJDBC implements CourseDao {
    ...
    private Teacher getTeacherForCourse(int id) {
        ...
        return jdbc.queryForObject(SELECT_TEACHER_FOR_COURSE, new TeacherJDBC.TeacherMapper(), id);
    }
    ...
    private List<Student> getStudentsForCourse(int id) {
        ...
        return jdbc.query(SELECT_STUDENTS_FOR_COURSE, new StudentJDBC.StudentMapper(), id);
    }
